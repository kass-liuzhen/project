async function renderList() {
    ...
    for (let item of data) {
        ...
        tdEl = document.createElement("td");
        tdEl.className = "col-atime";
        tdEl.innerText = item.atime;
        trEl.append(tdEl);
...
async function openEditDialog(item) {
    ...
    if (item) {
        dialogTitle.innerText = `修改学生信息 (#${item.cou_sn})`;
        ...
        form.elements.atime.value = item.atime ?? "";
    } else {
...
async function renderEditDialog() {
    ...
    save_btn.onclick = (e) => {
        let data = {
            ...
            atime: form.elements.atime.value,
        };
